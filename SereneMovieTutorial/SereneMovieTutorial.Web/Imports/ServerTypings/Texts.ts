    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace Destination {
                ...
                export const DistictName: string;
                export const Id: string;
        ...
        namespace Inventry {
            ...
            namespace IssueDetails {
                ...
                export const IssueIssueDate: string;
                export const IssueIssueNo: string;
                export const IssueOwner: string;
                export const IssueVehicleNo: string;
                export const ItemId: string;
                export const PartAmount: string;
                export const Partname: string;
                export const Partnumber: string;
                export const Qty: string;
                export const Rate: string;
                export const StockAsOnDate: string;
                export const TotalStock: string;
            }

            namespace IssueHeader {
                export const CreatedBy: string;
                export const CreatedByUsername: string;
                export const CreatedDate: string;
                export const IssueDate: string;
                export const IssueDetails: string;
                export const IssueId: string;
            ...
            namespace PurchaseOrder {
                ...
                export const Id: string;
                export const IsApproved: string;
                export const IsUnapproved: string;
                export const OrderDate: string;
                export const PartyId: string;
                export const PartyName: string;
                export const PoNo: string;
