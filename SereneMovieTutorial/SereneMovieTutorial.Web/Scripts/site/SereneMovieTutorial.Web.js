...
(function (SereneMovieTutorial) {
    var Inventry;
    (function (Inventry) {
        var VPoApproveForm = /** @class */ (function (_super) {
            __extends(VPoApproveForm, _super);
            function VPoApproveForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            VPoApproveForm.formKey = 'Inventry.VPoApprove';
            return VPoApproveForm;
        }(Serenity.PrefixedContext));
        Inventry.VPoApproveForm = VPoApproveForm;
    })(Inventry = SereneMovieTutorial.Inventry || (SereneMovieTutorial.Inventry = {}));
})(SereneMovieTutorial || (SereneMovieTutorial = {}));
var SereneMovieTutorial;
(function (SereneMovieTutorial) {
    ...
    (function (Inventry) {
        var VPoApproveRow;
        (function (VPoApproveRow) {
            VPoApproveRow.idProperty = 'Id';
            VPoApproveRow.nameProperty = 'PoNo';
            VPoApproveRow.localTextPrefix = 'Inventry.VPoApprove';
            VPoApproveRow.deletePermission = 'Administration:General';
            VPoApproveRow.insertPermission = 'Administration:General';
            VPoApproveRow.readPermission = 'Administration:General';
            VPoApproveRow.updatePermission = 'Administration:General';
        })(VPoApproveRow = Inventry.VPoApproveRow || (Inventry.VPoApproveRow = {}));
    })(Inventry = SereneMovieTutorial.Inventry || (SereneMovieTutorial.Inventry = {}));
})(SereneMovieTutorial || (SereneMovieTutorial = {}));
var SereneMovieTutorial;
(function (SereneMovieTutorial) {
    var Inventry;
    (function (Inventry) {
        var VPoApproveService;
        (function (VPoApproveService) {
            VPoApproveService.baseUrl = 'Inventry/VPoApprove';
            [
                'Create',
                'Update',
                'Delete',
                ...
                VPoApproveService[x] = function (r, s, o) {
                    return Q.serviceRequest(VPoApproveService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(VPoApproveService = Inventry.VPoApproveService || (Inventry.VPoApproveService = {}));
    })(Inventry = SereneMovieTutorial.Inventry || (SereneMovieTutorial.Inventry = {}));
})(SereneMovieTutorial || (SereneMovieTutorial = {}));
var SereneMovieTutorial;
(function (SereneMovieTutorial) {
...
(function (SereneMovieTutorial) {
    ...
    (function (FuelManagement) {
        var FuelDataGrid = /** @class */ (function (_super) {
            ...
            FuelDataGrid.prototype.createView = function () {
                var view = _super.prototype.createView.call(this);
                view.setGrouping([{
                        getter: 'InvoiceNo',
                        formatter: function (g) {
                            return 'Invoice No : ' + g.value + ' (' + g.count + ' Records)';
                        }
                    }]);
                return view;
            };
            FuelDataGrid.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
        ...
        var PurchaseOrderDialog = /** @class */ (function (_super) {
            ...
            function PurchaseOrderDialog(rows) {
                ...
                _this.form.PoNo.changeSelect2(function () {
                    ...
                    console.log(_this.form.PoNo.value);
                });
                return _this;
            }
            ...
            PurchaseOrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if ($(e.target).hasClass("inline-unapprove")) {
                    ...
                    if (!checked && item.IsUnapproved) {
                        Q.confirm("Do you really want to reset unapproved status for this PO?", function () {
                            Inventry.PurchaseOrderService.Update({
                                EntityId: item.Id,
                        ...
                        e.target.checked = item.IsUnapproved;
                    }
                }
            };
...
(function (SereneMovieTutorial) {
    var Inventry;
    (function (Inventry) {
        var VPoApproveDialog = /** @class */ (function (_super) {
            __extends(VPoApproveDialog, _super);
            function VPoApproveDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Inventry.VPoApproveForm(_this.idPrefix);
                return _this;
            }
            VPoApproveDialog.prototype.getFormKey = function () { return Inventry.VPoApproveForm.formKey; };
            VPoApproveDialog.prototype.getIdProperty = function () { return Inventry.VPoApproveRow.idProperty; };
            VPoApproveDialog.prototype.getLocalTextPrefix = function () { return Inventry.VPoApproveRow.localTextPrefix; };
            VPoApproveDialog.prototype.getNameProperty = function () { return Inventry.VPoApproveRow.nameProperty; };
            VPoApproveDialog.prototype.getService = function () { return Inventry.VPoApproveService.baseUrl; };
            VPoApproveDialog.prototype.getDeletePermission = function () { return Inventry.VPoApproveRow.deletePermission; };
            VPoApproveDialog.prototype.getInsertPermission = function () { return Inventry.VPoApproveRow.insertPermission; };
            VPoApproveDialog.prototype.getUpdatePermission = function () { return Inventry.VPoApproveRow.updatePermission; };
            VPoApproveDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = [];
            ...
            VPoApproveDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], VPoApproveDialog);
            return VPoApproveDialog;
        }(Serenity.EntityDialog));
        Inventry.VPoApproveDialog = VPoApproveDialog;
    })(Inventry = SereneMovieTutorial.Inventry || (SereneMovieTutorial.Inventry = {}));
})(SereneMovieTutorial || (SereneMovieTutorial = {}));
var SereneMovieTutorial;
(function (SereneMovieTutorial) {
    var Inventry;
    (function (Inventry) {
        var VPoApproveGrid = /** @class */ (function (_super) {
            __extends(VPoApproveGrid, _super);
            function VPoApproveGrid(container) {
                var _this = _super.call(this, container) || this;
                // initialize mixin
                _this.rowSelection = new Serenity.GridRowSelectionMixin(_this);
                return _this;
            }
            VPoApproveGrid.prototype.getColumnsKey = function () { return 'Inventry.VPoApprove'; };
            VPoApproveGrid.prototype.getDialogType = function () { return Inventry.VPoApproveDialog; };
            VPoApproveGrid.prototype.getIdProperty = function () { return Inventry.VPoApproveRow.idProperty; };
            VPoApproveGrid.prototype.getInsertPermission = function () { return Inventry.VPoApproveRow.insertPermission; };
            VPoApproveGrid.prototype.getLocalTextPrefix = function () { return Inventry.VPoApproveRow.localTextPrefix; };
            VPoApproveGrid.prototype.getService = function () { return Inventry.VPoApproveService.baseUrl; };
            //protected getButtons(): Serenity.ToolButton[] {
            //    let buttons = super.getButtons();
            //    buttons = buttons.filter(b => b.cssClass !== "add-button");
            //    return buttons;
            //}
            VPoApproveGrid.prototype.getColumns = function () {
                var _this = this;
                var columns = _super.prototype.getColumns.call(this);
                columns.unshift({
                    field: "SerielNo",
            ...
            VPoApproveGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons = buttons.filter(function (b) { return b.cssClass !== "add-button"; });
                // Approve button
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Do you really want to approve the selected purchase orders?", function () {
                            var count = 0;
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        Q.confirm("Do you really want to unapprove the selected purchase orders?", function () {
                            var count = 0;
                            selectedIds.forEach(function (id) {
                                Inventry.PurchaseOrderService.Update({
                                    EntityId: id,
            ...
            VPoApproveGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], VPoApproveGrid);
            return VPoApproveGrid;
        }(Serenity.EntityGrid));
        Inventry.VPoApproveGrid = VPoApproveGrid;
    })(Inventry = SereneMovieTutorial.Inventry || (SereneMovieTutorial.Inventry = {}));
})(SereneMovieTutorial || (SereneMovieTutorial = {}));
var SereneMovieTutorial;
(function (SereneMovieTutorial) {
